    ...
    <section class="relative  px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-32">
      <div class="flex flex-col md:flex-row lg:-mx-8">
        <div class="w-full lg:w-1/2 lg:px-8">
          ...
          <p class="mt-2 leading-relaxed">At Dr. Thomas Dooley's practice, we are committed to providing top-quality dental care with a personal touch. 
            Our office is equipped with the latest technology, ensuring the most efficient and comfortable treatments for our patients.
            We offer a wide range of services, including general dentistry, cosmetic procedures, and preventive care, all tailored to meet your unique needs.</p> 
        </div>
