<template>
<footer :class="'relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-16'">
    <div class="flex flex-wrap">
      <div class="w-full lg:w-2/6 lg:pr-8 mb-8 lg:mb-0">
        <h3 class="font-bold text-2xl">DentalPro</h3>
        <p class="text-gray-400 mt-2">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy.</p>
        <form class="mt-6">
            ...
            <div class="flex flex-col sm:flex-row">
              <input 
              class="appearance-none w-full bg-gray-200 text-gray-700 border rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 mb-4 sm:mb-0 sm:mr-2" 
              type="email" 
              placeholder="Enter Your Email Address"
            />
              <button type="submit" class="bg-teal-500 hover:bg-teal-400 text-white px-4 py-2 text-sm font-bold rounded ">Subscribe</button>
            
          </div>
        </form>
      </div>

      <div class="w-full sm:w-1/2 lg:w-1/6 mb-8 lg:mb-0">
        <h5 class="uppercase tracking-wider font-semibold">Treatments</h5>
        <ul class="mt-4 space-y-2">
          <li ><a href="#" class="opacity-75 hover:opacity-100">General Dentistry</a></li>
          <li ><a href="#" class="opacity-75 hover:opacity-100">Cosmetic Dentistry</a></li>
          <li><a href="#" class="opacity-75 hover:opacity-100">Oral Health</a></li>
        </ul>
      </div>

      <div class="w-full sm:w-1/2 lg:w-2/6 lg:pr-8 mb-8 lg:mb-0">
      ...
      <div class="w-full lg:w-1/6 ">
        ...
        <ul class="mt-4 flex justify-center lg:justify-start gap-4">
          <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current">
        ...
        <p class="text-sm text-gray-400 mt-12 text-center lg:text-left">© 2025 DentalPro. <br class="hidden lg:block">All Rights Reserved.
        </p>
      </div>
    </div>
    </footer>
