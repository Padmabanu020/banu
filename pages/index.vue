...
<header class="absolute top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
  ...
  <!-- Top Bar -->
  <div class="flex justify-between items-center px-6 py-2 text-sm border-b border-white/20">
...
<div class="flex items-center space-x-4">
  ...
  <div class="flex justify-between items-center px-6 py-4">
    ...
    <a
      href="#"
      class="hidden md:block bg-white text-blue-600 font-semibold px-4 py-2 rounded hover:bg-gray-100"
    >
      Book Appointment
    </a>
  </div>
...
<!-- Main Section with Content -->
      <section class="relative min-h-screen flex items-center justify-center px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64">
        <!-- Content Container -->
        <div class="absolute inset-0 bg-gradient-to-r from-blue-500 to-teal-400 opacity-90 ">
    <img 
      src="https://tailwindcss-templates.netlify.app/dentalpro/images/cover-bg.jpeg" 
      alt="Dental Office"
      class="relative w-full h-full object-cover opacity-50 rounded-br-[55%]";
  >
  </div>
        ...
        <div class="container mx-auto relative z-10">
          <div class="max-w-2xl">
            ...
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
                  A better life starts with a beautiful
                  smile. 
            </h1>
  ...
  <p class="italic text-sm mt-2 text-right">
    ...
    <section class="bg-gradient-to-r from-blue-500  to-teal-500 p-8">
...
<style>
/* Add this for font-awesome support if not already included in your project */
